...
COPY ./${LEMURBLDR_ROOT}/impl/mock_cfg.template /usr/share/mock_cfg.template
...
COPY --from=builder /usr/share/mock_cfg.template /usr/share/mock_cfg.template
USER root
